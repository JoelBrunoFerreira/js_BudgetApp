// MVC architecture , based on 3 classes: Model, View and Controller
// Each class follow the Module pattern architecture
...
var budgetController = (function() {
    ...
    // Adding a method to the Expense constructor - using prototype
    ...
    return {
        addItem: function(type, descpt, val) {
            var newItem, ID;
            ...
            if(type === 'exp') {
                newItem = new Expense(ID, descpt, val);
            } else if(type === 'inc') {
                newItem = new Income(ID, descpt, val);
            }
...
var UIController = (function() {
    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            // Replace the placeholder text with somo actual data
            ...
            // Nota: insertAdjacentHTML !== insertAdjacentElement
